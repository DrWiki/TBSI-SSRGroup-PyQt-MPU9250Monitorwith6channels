    ...
    def update2(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyZ == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[2].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamZ[t-500:t]))
                elif t>3:
    ...
    def update1(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyY == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[1].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamY[t-500:t]))
                elif t>3:
    ...
    def update0(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyX == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[0].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamX[t-500:t]))
                elif t>3:
    ...
    def update3(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyRX == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[3].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamRX[t-500:t]))
                elif t>3:
    ...
    def update4(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyRY == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[4].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamRY[t-500:t]))
                elif t>3:
    ...
    def update5(self):
        ...
        while 1:
            if self.MyCB.metadata.datareadyRZ == True:
                ...
                tt.append(t)
                if t>500:
                    self.PWPlot1Ploterlist[5].setData(np.array(tt[t-500:t]), np.array(self.MyCB.metadata.DataStreamRZ[t-500:t]))
                elif t>3:
